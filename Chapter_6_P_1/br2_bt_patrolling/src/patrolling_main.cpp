...
#include "br2_bt_patrolling/move_to_free_space.hpp" // hereeeeeeeeee 
...
int main(int argc, char * argv[])
{
  ...
  factory.registerNodeType<br2_bt_patrolling::MoveToFreeSpace>("MoveToFreeSpace"); // hereeeeeeeeee
